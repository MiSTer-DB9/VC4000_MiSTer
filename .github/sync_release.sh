...
UPSTREAM_REPO="https://github.com/MiSTer-devel/VC4000_MiSTer.git"
CORE_NAME=(VC4000)
...
UPSTREAM_CORE_NAME=(VC4000)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(vc4000.qpf)
COMPILATION_OUTPUT=(output_files/vc4000.rbf)
